...
<form method="post">
	<br>
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;margin-top:5px;width:95%;height:40px;line-height:40px;background:#000;color:#fff;text-align:center;margin-left:20px;padding-left:10px;border-radius:4px;border:1px solid aquamrine;"><?php echo"".$row['pet_name']."";?></h1>
		<div id="pet1">
			<ul>
		...
		<br><br><br><br>
		<li><a href="addtocart.php?id=<?php echo"".$row['pet_id']."";?>" style="width:100px;height:40px;background:#fff;color:#400040;border:1px solid #400040;text-decoration:none;padding:10px;">Addtocart</a></li>
		</ul>
			</form></div><br><br>
		<?php
		...
		$query->execute();
		echo"<div id='pet'>
		<h1 style='text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:20px;width:92%;background:#000;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;'>Relative Pets</h1>";
...
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:28%;width:92%;background:#000;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;">Feedbacks</h1>
<form method="post" enctype="multipart/form-data">
<div id="feedback">
	
	<textarea name="desc" placeholder="write feedback here"></textarea>
			...
			<?php
					...
					while($row1=$query->fetch()):
						...
						$query1->execute();
							...
							<li style='padding-top:55px;padding-left:200px;'><a href='comment.php?feedback_id=".$row1['feedback_id']."' style='text-decoration:none;font-size:20px;color:#000;border:1px solid #000;padding:5px;border-radius:4px;'>Comment($countfeedback)</a>  <b style='margin-left:20px;'>||</b> <a href='helpful.php?feedback_id=".$row1['feedback_id']."' style='text-decoration:none;font-size:20px;color:#000;margin-left:20px;border:1px solid #000;padding:5px;border-radius:4px;'>Helpful</a></li>
