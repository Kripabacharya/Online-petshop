...
<style>
body{background:#fff;}
#box1{border:1px solid black;padding-left:200px;color:black;}
table{width:95%;height:auto;margin-left:30px;border-collapse:collapse;}
table th{font-size:25px;border-collapse:collapse;border:2px solid #000;}
table td{text-align:center;padding:10px;font-size:20px;}
#show{background:#fff;}
</style>
</head>
<body>
<a href="index.php" style="color:000;font-size:20px;">Home</a>
<?php
	...
	echo"<h1 style='color:#fff;background:#000;text-align:center;line-height:50px;height:50px;'>Your Address</h1>";
		echo"<div id='box1'>";
		...
		echo"<h2>".$row['phoneno']."</h2><br><a href='edit_address.php?userid=".$row['id']."'><input type='submit' value='Edit' style='margin-bottom:20px;width:70px;height:40px;border-radius:4px;background:#fff;border:1px solid black;'></a>";
...
?>
					<div id="show">
						<h1 style="color:#fff;background:#000;text-align:center;line-height:50px;height:50px;">Your Orders</h1>
						<hr style="color:#000;">
						<table>
				<tr>
					<th>S.No</th>
