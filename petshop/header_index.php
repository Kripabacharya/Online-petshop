...
<style>
*{margin:0%;}
#header{background:#000;width:100%;height:150px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;}
#header img{width:250px;height:150px;border-radius:5px;}
#header h1{text-align:center;margin-top:-150px;color:#fff;}
#header ul li{float:right;margin-right:40px;font-size:24px;color:yellow;list-style-type:circle;margin-top:-20px;}
