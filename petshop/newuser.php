...
if(isset($_POST['submit']))
{
	...
	$pdoResult=$con->prepare("INSERT INTO newuser(username,phoneno,address,city,pincode,email,password) VALUES ('$username','$phone','$address','$city','$pincode','$email','$password')");
