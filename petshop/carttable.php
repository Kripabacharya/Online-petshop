...
table td{text-align:center;padding:10px;font-size:20px;}
		...
		<body>
				...
				?>
				<h1 style="width:95%;text-align:center;background:#000;color:#fff;height:50px;line-height:50px;margin-left:30px;margin-top:10px;border-radius:4px;margin-bottom:10px;">Cart Table </h1>
				<table>
				<tr>
					<th>S.No</th>
					<th>Pet Name</th>
				...
				<a href="deliveryaddress.php" style="margin-left:400px;border:1px solid #000;padding:10px;text-decoration:none;">checkout</a>
